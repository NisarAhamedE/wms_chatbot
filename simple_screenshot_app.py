...
class SimpleScreenshotApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Simple Screenshot Capture App")
    ...
    def setup_ui(self):
        ...
        # Title
        title_label = ttk.Label(main_frame, text="Simple Screenshot Capture App", 
                               font=('Arial', 16, 'bold'))
        ...
        if not TESSERACT_AVAILABLE:
            ...
            ocr_status = ttk.Label(main_frame, text="✓ OCR (Text Extraction) is available", 
        ...
        auto_instructions = ttk.Label(auto_frame, text="When enabled: Select area with mouse → Auto capture → Auto read text → Auto save to MD", 
    ...
    def create_selection_window(self):
        ...
        try:
            ...
            # Add instructions
            if self.auto_mode:
                instruction_text = "AUTO MODE: Click and drag to select area → Auto capture and save"
            else:
    ...
    def auto_capture_and_save(self):
        ...
        try:
            ...
            # Re-enable auto mode for next capture
            if self.auto_mode:
                self.root.after(2000, self.start_auto_selection)  # Restart selection after 2 seconds
...
def main():
    ...
    print("Starting Enhanced Screenshot Capture App with Auto Mode...")
